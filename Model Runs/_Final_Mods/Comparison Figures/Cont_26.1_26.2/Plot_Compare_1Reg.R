...
comp_name <- "Final_1Reg"                                                       # name for saving files

path <- here("Mods","___Final_Mods","1_Reg")                   # Assumes that comparison folder is inside the first model folder, but can update this to be elsewhere
