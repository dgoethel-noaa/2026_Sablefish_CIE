...
mod_name2 <- c("26.1i_1Reg_Cont_Upd_No_wAI_LLS", "26.2g_FAA_3Flt_log2domeS_No_Blks_F")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
