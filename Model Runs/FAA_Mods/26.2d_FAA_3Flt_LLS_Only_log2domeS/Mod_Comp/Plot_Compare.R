...
mod_name2 <- c("26.1i_1Reg_Cont_Upd_No_wAI_LLS", "26.2d_FAA_3Flt_LLS_Only_log2domeS")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
