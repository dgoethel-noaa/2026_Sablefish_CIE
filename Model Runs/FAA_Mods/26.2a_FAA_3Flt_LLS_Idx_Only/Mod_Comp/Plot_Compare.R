...
mod_name2 <- c("26.1i_1Reg_Cont_Upd_No_wAI_LLS", "26.2a_FAA_3Flt_LLS_Idx_Only")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
