...
mod_name <- '26.2b_FAA_3Flt_LLS_Only_DM_TVWAA'                                                    # Model name to use for saving files and labels
...
input_list <- Setup_Mod_SrvIdx_and_Comps(input_list = input_list,
                                         ...
                                         SrvAgeComps_LikeType =                # age comp likelihoods by survey fleet (none if not fit or not available for given fleet)
                                           c("Dirichlet-Multinomial", "Dirichlet-Multinomial","Dirichlet-Multinomial","none", "Multinomial"),
