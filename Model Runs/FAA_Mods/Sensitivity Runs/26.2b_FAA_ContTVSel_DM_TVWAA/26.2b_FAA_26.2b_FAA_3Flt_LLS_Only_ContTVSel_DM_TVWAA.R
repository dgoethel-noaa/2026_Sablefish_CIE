  ...
  mod_name <- '26.2b_FAA_3Flt_LLS_Only_ContTVSel_DM_TVWAA'                                                    # Model name to use for saving files and labels
  ...
  exp(sabie_rtmb_model$optim$par[str_detect(names(sabie_rtmb_model$optim$par), 'theta')])
