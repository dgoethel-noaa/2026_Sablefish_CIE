...
mod_name2 <- c("26.2b_FAA_3Flt_LLS_Only_ContTVSel",
               '26.2b_FAA_3Flt_LLS_Only_ContTVSel_DM',
               '26.2b_FAA_3Flt_LLS_Only_ContTVSel_DM_TVWAA',
               '26.2b_FAA_3Flt_LLS_Only_DM',
               '26.2b_FAA_3Flt_LLS_Only_TVWAA',
...
comp_name <- "FAA_Sensitivity"                                                       # name for saving files
...
info <- readRDS(here(path,"SPoRC_FAA_3LLS_1LLF.rds"))                            # read in data file to get years
