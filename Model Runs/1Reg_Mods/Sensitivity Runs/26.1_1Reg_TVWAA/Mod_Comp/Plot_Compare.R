...
mod_name2 <- c("26.1i_1Reg_Cont_Upd_No_wAI_LLS","26.1h_1Reg_Cont_Upd_LLS_Carry","26.1gg_1Reg_Cont_Upd_No_Len_2_Blks_F","26.1f_1Reg_Cont_Upd_No_CPUE",
               "26.1e_1Reg_Cont_Upd_Sex_M","26.1d_1Reg_Cont_Upd_Bio","25.12_1Reg_Cont")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
comp_name <- "_1Reg_Mod_Build"                                                       # name for saving files

path <- here("Mods",comp_name,mod_name2[1],"Mod_Comp")                   # Assumes that comparison folder is inside the first model folder, but can update this to be elsewhere
