...
mod_name2 <- c('26.1i_1Reg_Cont_Upd_No_wAI_LLS',
               '26.1i_1Reg_Cont_Upd_No_wAI_LLS_ContTVSel',
               '26.1i_1Reg_Cont_Upd_No_wAI_LLS_DM',
               '26.1i_1Reg_Cont_Upd_No_wAI_LLS_ContTVSel_DM',
               '26.1i_1Reg_Cont_Upd_No_wAI_LLS_TVWAA',
               '26.1i_1Reg_Cont_Upd_No_wAI_LLS_ContTVSel_DM_TVWAA'
               )                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files


comp_name <- "Sgl_Sensitvity"                                                       # name for saving files

path <- here("Mods","Sensitivity")                   # Assumes that comparison folder is inside the first model folder, but can update this to be elsewhere
...
for(i in 1:length(mod_name2)){
  rtmb_out[[i]] <- readRDS(here(path, mod_name2[i], paste0(mod_name2[i],"_model_results.RDS")))     # read in base assessment created from SPoRC model run R file
