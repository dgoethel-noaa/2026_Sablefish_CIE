...
mod_name2 <- c("26.1i_1Reg_Cont_Upd_No_wAI_LLS","26.1h_1Reg_Cont_Upd_LLS_Carry","26.1g_1Reg_Cont_Upd_No_Len_2_Blks_F")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
