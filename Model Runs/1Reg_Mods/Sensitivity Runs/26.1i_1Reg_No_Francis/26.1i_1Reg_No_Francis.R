...
mod_name <- '26.1i_1Reg_No_Francis'                                                    # Model name to use for saving files and labels
root_folder <- here("Mods", "_1Reg_Mod_Build","Sensitivity Runs")                                            # The root folder where runs will be stored (sub folders named with mod_name)
