...
mod_name2 <- c("26.1e_1Reg_Cont_Upd_Sex_M","26.1d_1Reg_Cont_Upd_Bio","26.1c_1Reg_Cont_Upd_TF_log")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
