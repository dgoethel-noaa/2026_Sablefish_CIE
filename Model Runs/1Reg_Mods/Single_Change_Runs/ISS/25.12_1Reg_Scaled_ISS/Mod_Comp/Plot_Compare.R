...
mod_name2 <- c("25.12_1Reg_Scaled_ISS","25.12_1Reg_Cont")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
comp_name <- "ISS"                                                       # name for saving files
grp2 <- "1Reg_ISS"
