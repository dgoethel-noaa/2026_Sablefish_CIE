...
mod_name <- '25.12_1Reg_Scaled_ISS'                                                    # Model name to use for saving files and labels
root_folder <- here("Mods", "1Reg_ISS")                                            # The root folder where runs will be stored (sub folders named with mod_name)
