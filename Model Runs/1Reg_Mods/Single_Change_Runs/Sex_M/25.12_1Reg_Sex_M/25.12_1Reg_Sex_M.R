...
mod_name <- '25.12_1Reg_Sex_M'                                                    # Model name to use for saving files and labels
root_folder <- here("Mods", "1Reg_Sex_M")                                            # The root folder where runs will be stored (sub folders named with mod_name)
