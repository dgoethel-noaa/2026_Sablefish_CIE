...
mod_name2 <- c("25.12_1Reg_TF_log","25.12_1Reg_Cont")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
comp_name <- "TF_log"                                                       # name for saving files

path <- here("Mods","1Reg_Selex",mod_name2[1],"Mod_Comp")                   # Assumes that comparison folder is inside the first model folder, but can update this to be elsewhere
