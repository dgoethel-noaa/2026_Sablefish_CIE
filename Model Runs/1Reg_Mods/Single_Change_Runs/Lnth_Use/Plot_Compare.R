...
mod_name2 <- c("25.12_Drop_TS_Upd_M_2026", "25.12_1Reg_Drop_Lnth","25.12_1Reg_Drop_Lnth+JLLS","25.12_1Reg_LLS_Kp_term_Lnth","25.12_1Reg_LLS_Raw_Lnth")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
comp_name <- "Lnth_Use"                                                       # name for saving files
