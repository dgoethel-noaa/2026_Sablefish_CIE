...
mod_name2 <- c("26.1i_1Reg_Cont_Upd_No_wAI_LLS_1.5x_CV", "26.1l_1Reg_Cont_Upd_No_wAI_LLS_Norm_CV","26.1m_1Reg_Cont_Upd_No_wAI_LLS_2x_CV")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
comp_name <- "_Surv_CV"                                                       # name for saving files
