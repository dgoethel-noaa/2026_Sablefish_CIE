...
mod_name2 <- c("25.12_1Reg_Surv_CV_1.5","25.12_1Reg_Surv_CV","25.12_1Reg_Cont")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
comp_name <- "Surv_CV"                                                       # name for saving files
grp2 <- "1Reg_Surv_CV"

path <- here("Mods",grp2,mod_name2[1],"Mod_Comp")                   # Assumes that comparison folder is inside the first model folder, but can update this to be elsewhere
