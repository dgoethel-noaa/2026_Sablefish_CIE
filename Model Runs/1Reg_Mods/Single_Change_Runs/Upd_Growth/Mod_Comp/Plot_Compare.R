...
mod_name2 <- c("25.12_1Reg_Upd_Growth","25.12_1Reg_Cont")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
comp_name <- "Upd_Bio"                                                       # name for saving files
grp2 <- "1Reg_Bio"
