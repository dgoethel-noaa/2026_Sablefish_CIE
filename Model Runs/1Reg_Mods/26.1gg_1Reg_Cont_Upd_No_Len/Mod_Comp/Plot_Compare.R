...
mod_name2 <- c("26.1gg_1Reg_Cont_Upd_No_Len","26.1f_1Reg_Cont_Upd_No_CPUE","26.1e_1Reg_Cont_Upd_Sex_M","26.1d_1Reg_Cont_Upd_Bio","25.12_1Reg_Cont")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
