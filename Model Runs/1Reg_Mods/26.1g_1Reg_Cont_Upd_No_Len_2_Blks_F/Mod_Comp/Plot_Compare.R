...
mod_name2 <- c("26.1g_1Reg_Cont_Upd_No_Len_2_Blks_F","26.1f_1Reg_Cont_Upd_No_CPUE","26.1e_1Reg_Cont_Upd_Sex_M")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
