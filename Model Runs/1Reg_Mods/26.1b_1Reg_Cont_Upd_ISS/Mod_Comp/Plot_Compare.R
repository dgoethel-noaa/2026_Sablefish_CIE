...
mod_name2 <- c("26.1b_1Reg_Cont_Upd_ISS","26.1a_1Reg_Cont_Upd","25.12_1Reg_Cont")                         # names of model want to compare, these must match the names used for the SPoRC outputs results rdata files
