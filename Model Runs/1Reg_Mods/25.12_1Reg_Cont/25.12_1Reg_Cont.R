...
mod_name <- '25.12_1Reg_Cont'                                                    # Model name to use for saving files and labels
...
input_list <- Setup_Mod_SrvIdx_and_Comps(input_list = input_list,
                                         ...
                                         ObsSrvIdx_SE =                        # Observed fishery independent survey standard errors
                                           (SPoRC_one_reg$ObsSrvIdx_SE)*2,        # since moving to variance weighted likelihoods, need to convert to appropriate variance (not SE); generally LLS (JPN and DOM) CV ~ 0.05, TS ~ 0.1
