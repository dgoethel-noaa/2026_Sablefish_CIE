...
comp_name <- "_1Reg_Comp"                                                       # name for saving files

path <- here("Mods",comp_name,"__Final_stepwise")                   # Assumes that comparison folder is inside the first model folder, but can update this to be elsewhere
